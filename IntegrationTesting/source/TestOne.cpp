...
void TestOne::testUsingProc() {
	...
	string proc[] = {"proc"};
	set<string> procSet(proc, proc + 1);
...
void TestOne::testUsingMultipleProc() {
	...
	set<string> procSet1(proc1, proc1 + 1);
	set<string> procSet2(proc2, proc2 + 2);
