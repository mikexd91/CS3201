...
class AffectsStarBipClauseTest : public CPPUNIT_NS::TestFixture {
	CPPUNIT_TEST_SUITE( AffectsStarBipClauseTest );
	...
	CPPUNIT_TEST( testFixedGenericAcrossProcPass );
...
public:
	...
	void testFixedGenericAcrossProcPass();
